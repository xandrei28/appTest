...
var salon401: NursePatient[] = [
  {
    ...
    tasks: [
      { label: "Furosemid 08:00", variant: "gold" },
      { label: "TA/FC la 10:00", variant: "warn" },
      { label: "Bilant renal", variant: "blue" },
    ],
  ...
  },
  {
    ...
    tasks: [
      { label: "Ceftriaxona 10:00", variant: "gold" },
      { label: "Salbutamol neb 08:00", variant: "purp" },
    ],
    doctor: "Medic curant: Dr. Popescu A.",
  ...
  },
  {
    ...
    alerts: [],
    tasks: [
      { label: "D-dimeri control URGENT", variant: "err" },
      { label: "Transport CT 10:30", variant: "blue" },
      { label: "LMWH 09:00", variant: "gold" },
    ],
    doctor: "Medic curant: Dr. Popescu A.",
...
var salon402: NursePatient[] = [
  {
    ...
    tasks: [
      { label: "TA/FC/GCS la 10:00", variant: "warn" },
      { label: "Nicardipina continuu", variant: "gold" },
    ],
    doctor: "Medic curant: Dr. Popescu A.",
    borderColor: "border-l-err",
  },
  {
    ...
    tasks: [
      { label: "Ringer 250mL/h", variant: "gold" },
      { label: "Paracetamol 14:00", variant: "gold" },
    ],
    doctor: "Medic curant: Dr. Popescu A.",
  ...
  },
  {
    ...
    tasks: [
      ...
      { label: "Externare pregatita", variant: "ok" },
    ],
    doctor: "Medic curant: Dr. Popescu A.",
    borderColor: "border-l-ok",
  },
...
function PatientCardItem({ patient }: { patient: NursePatient }) {
  return (
    <div className={"bg-bg-card border border-brd rounded-r p-3.5 border-l-[3px] " + patient.borderColor + " cursor-pointer hover:bg-bg-card-h transition-colors"}>
      <div className="flex items-start justify-between mb-1">
        ...
        <div className="text-[12px] text-tx3 flex-shrink-0">{patient.bed}</div>
      </div>
      ...
      <div className="flex flex-wrap gap-1.5 mb-2.5">
        ...
        {patient.alerts.map(function (a) {
          return <Badge key={a.label} variant={a.variant}>{a.label}</Badge>;
        })}
      </div>
      ...
      <div className="pt-2.5 border-t border-brd">
        ...
        <div className="flex flex-wrap gap-1.5">
          {patient.tasks.map(function (t) {
            return <Badge key={t.label} variant={t.variant} className="!text-[10px]">{t.label}</Badge>;
          })}
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <div className="space-y-3 mb-5">
        {salon401.map(function (p) {
          return <PatientCardItem key={p.name} patient={p} />;
        })}
      </div>
