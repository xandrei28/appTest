  ...
  return (
    <div>
      ...
      <InfoBanner variant="teal" className="mb-3.5">
        <span className="text-[16px]">\u{1F550}</span>
        <span>
      ...
      <InfoBanner variant="err" className="mb-2">
        ...
        <span>
          <strong>Ionescu Maria</strong> — FC 128, SpO&#x2082; 91%. Atentie speciala la administrare.
        </span>
      </InfoBanner>
      ...
      <Card className="!border-l-[3px] !border-l-purp">
        ...
        <div className="text-[13px] text-tx2 leading-relaxed">
          Ionescu Maria: agitatie psihomotorie la ora 02:00, s-a administrat Diazepam 5mg p.o. conform indicatie Dr. Ionescu. FC oscilanta 110–128. Vasilescu Ion: afebril, noapte linistita. Stan Alexandru: SpO&#x2082; 92% sub O&#x2082; 4L, mentinut. Diureza 24h Ionescu: 1800mL.
        </div>
